...
export default function App() {
  ...
  const handleVinSubmit = async (e) => {
    ...
    try {
      // Print the VIN to console
      // console.log('VIN entered:', vinInput.trim())
      // console.log('Email entered:', emailInput.trim())
      ...
      if (result.success) {
        ...
        window.location.href = 'https://pay.paddle.io/hsc_01k4j5gaxqj5e2xm1t1kfwkyq2_nzz1zmtmxvsxv3y59jvavjzeng41zdzt'
      } else {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote: "Very reassuring before buying a used vehicle. ProvenCheck provided a detailed and accurate report.",
                author: "JC",
                verified: true
              },
              {
                quote: "Slightly pricey, but saved me from a huge mistake. The mileage was tampered, and ProvenCheck caught it.",
                author: "Sasha",
                verified: true
              },
              {
                quote: "Everything matched perfectly. ProvenCheck helped me catch an odometer fraud I would never have noticed.",
                author: "Rolando",
                verified: true
              }
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              ProvenCheck: Leading the way in automotive data
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Since 2020, ProvenCheck has expanded to over 35 international markets. We pull data from 900+ trusted sources, including national vehicle registries, insurance records, law enforcement, and government agencies.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              How ProvenCheck Works
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get comprehensive vehicle history reports from ProvenCheck in just three simple steps. Our advanced system processes data from hundreds of sources to give you the complete picture.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Know the Real Market Value with ProvenCheck
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our market analysis helps you understand if you&apos;re getting a fair deal. ProvenCheck compares similar vehicles and factors in the vehicle&apos;s history to give you accurate pricing information.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              ProvenCheck Industry Recognition &amp; Awards
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ProvenCheck has been recognized by leading automotive organizations and has received numerous awards for our comprehensive reporting and customer service.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Frequently Asked Questions about ProvenCheck
            </h2>
            <p className="text-xl text-gray-600">
          ...
          <div className="space-y-6">
            {[
              {
                question: "How accurate are ProvenCheck reports?",
              ...
              },
              {
                ...
                answer: "ProvenCheck offers the most comprehensive database with over 1 billion data points, faster delivery times, 24/7 customer support, and competitive pricing. We also provide market value analysis and detailed damage assessments."
              }
            ].map((faq, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-md">
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-green-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              See What You Get in Every ProvenCheck Report
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Every ProvenCheck report is comprehensive and easy to understand. Here&apos;s a preview of what information you&apos;ll receive from our vehicle history service.
            </p>
          </div>
          ...
          <div className="mt-12 text-center">
            ...
            <p className="mt-4 text-gray-600">Sample report - Actual ProvenCheck reports contain much more detailed information</p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
            © 2015 ProvenCheck. All rights reserved. | Vehicle History Reports & VIN Checks
          </div>
        </div>
      </footer>
