...
export const metadata = {
  title: "Terms of Service - ProvenCheck | Vehicle History Reports",
  description: "Terms of Service for ProvenCheck vehicle history reports. Read our terms and conditions for using our VIN check services.",
  robots: {
    index: true,
    follow: true,
  },
          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                By accessing and using ProvenCheck&apos;s website and services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ProvenCheck provides vehicle history reports based on Vehicle Identification Numbers (VINs). Our service includes:
              </p>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-red-700">
                      <p><strong>ALL SALES ARE FINAL.</strong> ProvenCheck is a digital service providing vehicle history reports. Once a report is generated and delivered, no refunds will be issued under any circumstances.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                All content, features, and functionality on our website and in our reports are owned by ProvenCheck and are protected by international copyright, trademark, and other intellectual property laws. You may not reproduce, distribute, or create derivative works without our express written permission.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                In no event shall ProvenCheck be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or use, arising out of or relating to your use of our service, even if we have been advised of the possibility of such damages. Our total liability shall not exceed the amount paid for the service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                You agree to indemnify, defend, and hold harmless ProvenCheck from and against any and all claims, damages, obligations, losses, liabilities, costs, and expenses arising from your use of our service or violation of these terms.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                These terms shall be governed by and construed in accordance with the laws of the jurisdiction where ProvenCheck operates, without regard to conflict of law principles.
              </p>
            </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap justify-center md:justify-end gap-6 text-sm">
              ...
              <Link href="/terms" className="hover:text-green-400 transition-colors font-semibold">Terms & Conditions</Link>
              <Link href="/refund" className="hover:text-green-400 transition-colors">Refund Policy</Link>
            </div>
          </div>

          <div className="mt-6 pt-6 border-t border-gray-800 text-center text-gray-400">
            © 2015 ProvenCheck. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
