            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-red-700">
                  <p><strong>ALL SALES ARE FINAL AND NON-REFUNDABLE.</strong> ProvenCheck is a digital service that provides immediate delivery of vehicle history reports. Please read this policy carefully before making a purchase.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ProvenCheck operates a strict no-refund policy for all purchases. Once payment is processed and a vehicle history report is generated, <strong>no refunds will be issued under any circumstances</strong>.
              </p>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                When you purchase a ProvenCheck report for $39.99, you receive:
              </p>
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg mt-4">
                <p className="text-gray-700">
                  ...
                  <strong>Website:</strong> <Link href="https://provencheck.store" className="text-blue-600 hover:text-blue-700">https://provencheck.store</Link><br/>
