            ...
            <div className="space-y-6">
              <div className="flex items-start text-left">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Our ProvenCheckStore system is now processing your VIN and gathering data from over 900 trusted sources worldwide.</p>
                </div>
              </div>
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-800 text-center text-gray-400">
            © 2015 ProvenCheckStore. All rights reserved. | Vehicle History Reports & VIN Checks
          </div>
        </div>
      </footer>
    </div>
